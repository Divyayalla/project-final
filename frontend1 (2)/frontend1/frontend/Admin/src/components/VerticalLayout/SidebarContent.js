        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
              {/* <li><Link to="/Viewevents">{props.t("View events")}</Link></li>
                <li><Link to="/owlcoder">{props.t("Owl coder")}</Link></li>
                <li><Link to="/drconnect">{props.t("Driveready Connect")}</Link></li>
                <li><Link to="/projectspace">{props.t("Project Space")}</Link></li>
                <li><Link to="/driveready">{props.t("Drive Ready")}</Link></li>
                <li><Link to="/tconnect">{props.t("T-Connect")}</Link></li>
                <li><Link to="/grow">{props.t("Grow")}</Link></li>
                <li><Link to="/pprojectspace">{props.t("Pega Project Space")}</Link></li> */}
                <li><Link to="/getevent">{props.t("Event Info")}</Link></li> 
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("EventVisuals")}</span>
              </Link>
              <ul className="sub-menu">
                <li><Link to="/appathon">{props.t("Appathon")}</Link></li>
                <li><Link to="/driveready">{props.t("Driveready")}</Link></li>
                <li><Link to="/goldenday">{props.t("Goldenday")}</Link></li>
                <li><Link to="/owlcoder">{props.t("Owlcoder")}</Link></li>
                <li><Link to="/projectspace">{props.t("Project Space")}</Link></li>
                <li><Link to="/skillersday">{props.t("Skillersday")}</Link></li>
              </ul>
            </li>
                <li>
                <Link to="/calendar" className=" waves-effect">
